...
public class Calculator2 extends JFrame{
    ...
    private JButton one, two, three,four, five, six, seven, eight, nine, zero, 
            add, sub, multiply, div, equals,off,reset;
    ...
    public Calculator2(){
        ...
        one.setPreferredSize(dim);
         ...
         zero.setPreferredSize(new Dimension(200,25));
        ...
        contentPanel.add(multiply);contentPanel.add(div);contentPanel.add(equals); contentPanel.add(off);
